...
# 2. Instalar Inkstitch CLI (Versión ejecutable para Linux v3.1.0)
RUN curl -L -f "https://github.com/inkstitch/inkstitch/releases/download/v3.1.0/inkstitch-v3.1.0-linux-en_US.tar.xz" -o inkstitch.tar.xz \
